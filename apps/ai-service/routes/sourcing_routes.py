...
async def get_github_profile(github_id: str):
    """
    Fetch GitHub profile details, repositories, and AI repo summaries for a given GitHub ID.
    """
...
async def get_linkedin_profile(linkedin_id: str):
    """
    Fetch LinkedIn profile details, experience, skills, and recent posts for a given LinkedIn ID.
    """
...
async def get_external_candidate_profile(request: ExternalSourcingRequest):
    """
    Fetch unified external talent profile (GitHub + LinkedIn), extract skills, generate 768-dim vector embedding,
    and compute match score against job requirements.
    """
