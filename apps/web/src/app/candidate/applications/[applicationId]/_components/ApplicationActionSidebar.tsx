...
import { Gift, Calendar, Video, Sparkles, ArrowRight } from '@/lib/lucide-google-icons';

import { NextStepItem, toneClass, badgeToneClass } from './applicationSidebar.types';

interface ApplicationActionSidebarProps {
  app: Application;
  offer?: Offer | null;
...
export function ApplicationActionSidebar({
  app,
  offer,
  nextSteps,
  onOpenScreeningModal,
}: ApplicationActionSidebarProps) {
  return (
        ...
        <div className="rounded-3xl border border-purple-200 dark:border-purple-800 bg-purple-50/50 dark:bg-purple-950/40 p-6 shadow-md backdrop-blur-md glass-panel space-y-4">
          ...
          <p className="text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-medium">
            ...
            <span className="text-slate-900 dark:text-slate-100 font-bold">
              {app.confirmedSlot || app.interviewScheduledAt || 'Scheduled'}
            </span>.
          </p>
          <Link
