...
export function CandidateQuickPrepHub() {
  ...
  return (
    <div className="glass-card p-6 border-slate-200/80 dark:border-slate-800/80 bg-slate-900/90 dark:bg-slate-900/80 space-y-5">
        ...
        {prepTracks.map((track) => {
          ...
          return (
            <Link
              key={track.title}
              href="/candidate/mock/new"
              className="p-4 rounded-xl bg-slate-800/70 hover:bg-slate-800 border border-slate-700/60 hover:border-slate-600 transition-all flex flex-col justify-between group cursor-pointer"
            >
              ...
              <div className="mt-3 pt-2 border-t border-slate-700/60 flex items-center justify-between text-[10px] font-bold text-slate-400 group-hover:text-emerald-400">
