  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      <div className="glass-card glass-card-indigo p-5 flex flex-col justify-between relative overflow-hidden group">
        ...
        <div className="mt-4">
          <span className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{totalApplications}</span>
          <span className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-0.5">
            Total Applications
          </span>
        </div>
        <div className="mt-3 pt-3 border-t border-slate-200/80 dark:border-slate-800/60 flex items-center justify-between text-xs font-semibold">
          <span className="text-slate-500 dark:text-slate-400 text-[11px]">
            {totalApplications > 0 ? `${totalApplications} active job listings` : 'No active applications'}
          </span>
          <Link href="/candidate/applications" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 flex items-center gap-1">
            <span>View</span>
      ...
      <div className="glass-card glass-card-emerald p-5 flex flex-col justify-between relative overflow-hidden group">
        ...
        <div className="mt-4">
          <span className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{scheduledInterviewsCount}</span>
          <span className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-0.5">
        ...
        <div className="mt-3 pt-3 border-t border-slate-200/80 dark:border-slate-800/60 flex items-center justify-between text-xs font-semibold">
          ...
          <Link href="/candidate/applications" className="text-emerald-600 dark:text-emerald-400 hover:text-emerald-500 dark:hover:text-emerald-300 flex items-center gap-1">
            <span>Check</span>
            <ArrowRight className="h-3 w-3" />
          </Link>
        </div>
      ...
      <div className="glass-card glass-card-purple p-5 flex flex-col justify-between relative overflow-hidden group">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 uppercase tracking-wider">
            AI Rating
          </span>
        </div>
        <div className="mt-4 flex items-baseline justify-between">
          {latestMockScore !== null ? (
            <div>
              <span className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{latestMockScore}%</span>
              <span className="block text-[11px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wider mt-0.5">
                Latest Mock Score
              </span>
            </div>
        ...
        <div className="mt-3 pt-3 border-t border-slate-200/80 dark:border-slate-800/60 flex items-center justify-between text-xs font-semibold">
          {latestMockScore !== null ? (
            <>
              <span className="text-slate-500 dark:text-slate-400 text-[11px]">Based on recent session</span>
              <Link href="/candidate/mock/history" className="text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 flex items-center gap-1">
                <span>History</span>
                <ArrowRight className="h-3 w-3" />
              </Link>
            </>
      ...
      <div className="glass-card p-5 flex flex-col justify-between relative overflow-hidden group border-amber-500/20">
        ...
        <div className="mt-3 pt-3 border-t border-slate-200/80 dark:border-slate-800/60 flex items-center justify-between text-xs font-semibold">
          <span className="text-slate-500 dark:text-slate-400 text-[11px]">Profile & AI status active</span>
          <Link href="/candidate/profile" className="text-amber-600 dark:text-amber-400 hover:text-amber-500 dark:hover:text-amber-300 flex items-center gap-1">
            <span>Profile</span>
            <ArrowRight className="h-3 w-3" />
          </Link>
        </div>
