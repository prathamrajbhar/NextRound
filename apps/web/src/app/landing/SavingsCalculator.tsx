    ...
    <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-24 w-full text-left">
      <div className="rounded-3xl border border-white/60 dark:border-slate-800/80 bg-white/40 dark:bg-slate-900/60 backdrop-blur-md shadow-xl p-6 sm:p-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-5 pt-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs font-extrabold text-slate-700 dark:text-slate-300">
                ...
                <span className="bg-brand-50 dark:bg-slate-950/60 text-brand-700 dark:text-emerald-400 px-3 py-1 rounded-xl border border-brand-100 dark:border-slate-850">
                  {hiresPerMonth} hires
                </span>
              </div>
              <input
                ...
                className="w-full h-2 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-850 rounded-lg appearance-none cursor-pointer accent-brand-600 dark:accent-orange-500"
              />
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {/* Result 1: Cost saved */}
          <div className="p-6 rounded-2xl border border-white/60 dark:border-slate-850 bg-white/50 dark:bg-slate-950/40 relative overflow-hidden flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              ...
              <span className="text-3xl font-extrabold text-slate-850 dark:text-emerald-400 mt-1 block">
          ...
          <div className="p-6 rounded-2xl border border-white/60 dark:border-slate-850 bg-white/50 dark:bg-slate-950/40 relative overflow-hidden flex flex-col justify-between min-h-[140px]">
            ...
            <div>
              ...
              <span className="text-3xl font-extrabold text-slate-850 dark:text-slate-200 mt-1 block">
                {totalHoursSaved} hrs
              </span>
            </div>
          </div>
          ...
          <div className="sm:col-span-2 p-5 rounded-2xl border border-brand-200 bg-brand-50/20 dark:border-orange-900/40 dark:bg-orange-950/10 flex items-center gap-3.5">
            ...
            <div className="text-xs">
              <p className="font-extrabold text-slate-855 dark:text-slate-200">Accelerated Hiring Speed</p>
