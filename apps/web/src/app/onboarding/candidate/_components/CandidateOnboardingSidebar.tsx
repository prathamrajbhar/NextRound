...
import { Check, Sparkles, ShieldCheck } from '@/lib/lucide-google-icons';
...
interface CandidateOnboardingSidebarProps {
  steps: OnboardingStep[];
  current: number;
}

export function CandidateOnboardingSidebar({ steps, current }: CandidateOnboardingSidebarProps) {
      ...
      <div className="pt-8 relative z-10">
        <div className="p-4 sm:p-5 rounded-2xl border border-slate-800 bg-slate-900/80 backdrop-blur-md space-y-3 shadow-lg">
          ...
          <p className="text-xs text-slate-400 leading-normal">
            Your profile powers the AI screening, matching and mock-interview agents.
          </p>
        </div>
      </div>
    </aside>
