...
import { FileUp, Check, Loader2, Sparkles, RefreshCw } from '@/lib/lucide-google-icons';
import { apiClient } from '@/lib/apiClient';
import { ParsedProfilePayload } from './candidateOnboarding.types';

interface PersonalResumeUploadBannerProps {
  resumeFile: File | null;
  onFileSelect: (file: File) => void;
  mergeParsedProfile?: (parsed: ParsedProfilePayload, rawText?: string) => void;
}

export function PersonalResumeUploadBanner({
  resumeFile,
  onFileSelect,
  mergeParsedProfile,
}: PersonalResumeUploadBannerProps) {
