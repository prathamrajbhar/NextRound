...
export function UnifiedAssessmentSession({
  ...
  if (activeRoundTrack === 'aptitude') {
    return (
      <div className="fixed inset-0 z-50 w-screen h-screen bg-slate-950 text-white overflow-y-auto p-4 flex flex-col space-y-2 animate-in fade-in duration-300">
