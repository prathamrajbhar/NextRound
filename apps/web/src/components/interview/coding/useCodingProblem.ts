...
/**
 * Loads a live LLM-generated coding problem from the backend (either the
 * application's assessment or the standalone generator) and normalizes the
 * loosely-typed API payload into the local `CodingProblem` shape.
 */
