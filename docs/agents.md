...
**Purpose:** Aggregates all stage scores into a composite evaluation and runs a blind demographic bias audit before producing a final confidence-rated score.
...
[confidence_estimation]
    ...
    ▼
[bias_audit]
    │  - Checks name-origin correlation
    │  - Checks school prestige correlation
    │  - Checks geography correlation
    │  - Flags anomalies vs. cohort baseline
    ▼
...
**DB Modified:** `Evaluation` (all score fields, bias_report), `AgentLog`
...
[compute_funnel_metrics]
    ...
    ▼
[compute_bias_trend]
    │  - bias audit score stability over time
    │  - anomaly rate trend
    ▼
[generate_pdf_report]
