...
| GET | `/evaluations/:applicationId/bias-report` | HR Org Scoped | Full demographic bias audit report JSON. |
...
| Method | Path | Auth | Description |
|---|---|---|---|
| GET | `/analytics/org` | HR Org Scoped | Funnel stats, time-to-hire, score distribution, bias trends. Query: `range` (e.g., `7d`, `30d`). |
