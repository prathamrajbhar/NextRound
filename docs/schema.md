...
### 3.4 `Evaluation.bias_report`
```json
{
  "anomaly_detected": false,
  "checks": [
    { "dimension": "name_origin_correlation", "result": "pass", "score_delta": 0.02 },
    { "dimension": "school_prestige_correlation", "result": "pass", "score_delta": -0.01 },
    { "dimension": "geography_correlation", "result": "pass", "score_delta": 0.0 }
  ],
  "overall_risk": "low",
