...
Embeddings are **768-dimensional**, generated by the Python AI service using the local FastEmbed ONNX model `BAAI/bge-base-en-v1.5` and stored via internal Express callbacks (`/api/v1/internal/*`).
